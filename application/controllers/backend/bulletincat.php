...
class Bulletincat extends Backend_Controller {
	...
	{				
		...
		$list = $this->c_model->GetList( "bulletincat" , "" ,FALSE, $this->per_page_rows , $this->page , array("sort"=>"asc","sn"=>"desc") );
	...
	public function editContent()
	{
		...
		{		
			$news_info = $this->c_model->GetList( "bulletincat" , "sn =".$content_sn);
