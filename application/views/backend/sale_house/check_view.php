...
<div class="row">
    <div class="col-xs-12 form-horizontal">
        <div class="hr hr-12 hr-dotted"></div>
    <?php echo '<h3>∎'.$comm_data['name'].' 售屋資料</h3>';?>
		<?php
		...
		echo textDisplay("<span class='red'>＊</span>售屋標題", "title", $edit_data);
		...
		<div class="form-group ">
			...
			<div class="col-xs-12 col-sm-6">
				<label class="middle" style="width:100%;">
				<?php echo generate_radio('sale_type', tryGetData('rent_type', $edit_data, 'a'), 'rent_sale_type_array', 'disabled');?>
				</label>
			</div>
		</div>
		<div class="form-group ">
			...
			<div class="col-xs-12 col-sm-8">
				<label class="middle" style="width:100%;">
				<?php echo generate_radio('direction', tryGetData('direction', $edit_data, 'a'), 'house_direction_array', 'disabled');?>
				</label>
			</div>
		</div>
		<?php
// echo textDisplay("<span class='red'>＊</span>格局 - 房數：", "room", $edit_data, ' 房', 'width:40px');
		echo textDisplay("<span class='red'>＊</span>格局 - 房數", "room", $edit_data, ' 房', 'width:40px');
		echo textDisplay(" - 廳數", "livingroom", $edit_data, ' 廳', 'width:40px');
		echo textDisplay(" - 衛數", "bathroom", $edit_data, ' 衛', 'width:40px');
		echo textDisplay(" - 陽台數", "balcony", $edit_data, ' 陽台', 'width:40px');
		echo textDisplay("<span class='red'>＊</span>面積", "area_ping", $edit_data, ' 坪', 'width:80px');
		echo textDisplay("<span class='red'>＊</span>公設比", "pub_ratio", $edit_data, ' %', 'width:80px');
		echo textDisplay("<span class='red'>＊</span>坪數說明", "area_desc", $edit_data,'ex.主建物、主建物 和 附屬建物坪數');
		echo textDisplay("裝潢程度", "decoration", $edit_data);
		?>
		<div class="hr hr-16 hr-dotted"></div>
		<?php
		...
		echo textDisplay("<span class='red'>＊</span>屋 齡", "house_age", $edit_data,  ' 年', 'width:40px');
		echo textDisplay("<span class='red'>＊</span>總 價", "total_price", $edit_data,  ' 萬元', 'width:40px');
		echo textDisplay("<span class='red'>＊</span>每坪單價", "unit_price", $edit_data,  ' 萬元', 'width:40px');
		echo textDisplay("管理費", "manage_fee", $edit_data,  ' 元', 'width:40px');
		...
		<div class="form-group ">
			...
			<div class="col-xs-12 col-sm-4">
				<label class="middle" style="width:100%;">
				<?php echo generate_radio('flag_rent', tryGetData('flag_rent', $edit_data, 0), 'yes_no_array', 'disabled');?>
				</label>
			</div>
		</div>
		<div class="form-group ">
