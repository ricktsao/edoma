...
-- 正在導出表  community.album 的資料：~0 rows (大約)
/*!40000 ALTER TABLE `album` DISABLE KEYS */;
/*!40000 ALTER TABLE `album` ENABLE KEYS */;


-- 導出  表 community.album_item 結構
...
-- 正在導出表  community.house_to_sale_photo 的資料：0 rows
...
-- 正在導出表  community.it_sessions 的資料：0 rows
...
-- 正在導出表  community.repair 的資料：0 rows
/*!40000 ALTER TABLE `repair` DISABLE KEYS */;
/*!40000 ALTER TABLE `repair` ENABLE KEYS */;


-- 導出  表 community.repair_reply 結構
...
-- 正在導出表  community.suggestion 的資料：0 rows
...
-- 正在導出表  community.sys_backend_log 的資料：0 rows
...
-- 正在導出表  community.sys_frontend_log_2016 的資料：0 rows
...
-- 正在導出表  community.sys_function 的資料：~0 rows (大約)
...
-- 正在導出表  community.sys_message_assign 的資料：~0 rows (大約)
...
-- 正在導出表  community.sys_module 的資料：~47 rows (大約)
...
-- 正在導出表  community.sys_user_belong_group 的資料：~1 rows (大約)
...
-- 正在導出表  community.sys_user_group_b_auth 的資料：~164 rows (大約)
...
-- 導出  表 community.user_message 結構
...
-- 正在導出表  community.user_message 的資料：~0 rows (大約)
/*!40000 ALTER TABLE `user_message` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_message` ENABLE KEYS */;


-- 導出  表 community.user_message_assign 結構
...
-- 正在導出表  community.user_parking 的資料：0 rows
...
-- 正在導出表  community.web_menu 的資料：~0 rows (大約)
...
-- 正在導出表  community.web_menu_banner 的資料：~0 rows (大約)
...
-- 正在導出表  community.web_menu_content 的資料：0 rows
...
-- 正在導出表  community.web_setting 的資料：17 rows
...
INSERT INTO `web_setting` (`sn`, `title`, `key`, `value`, `memo`, `type`, `sort`, `launch`, `update_date`) VALUES
	...
	(3, '社區名稱', 'comm_name', '', '', 'text', 30, 1, '2016-05-02 00:20:49'),
	(12, '社區簡介', 'comm_desc', '', '', 'textarea', 35, 1, '2016-05-02 00:20:49'),
...
INSERT INTO `sys_user` (`comm_id`, `sn`, `is_sync`, `building_id`, `name`, `role`, `title`, `id`, `app_id`, `gender`, `account`, `is_contact`, `is_owner`, `owner_addr`, `password`, `is_manager`, `manager_title`, `voting_right`, `gas_right`, `email`, `tel`, `phone`, `addr`, `is_chang_pwd`, `start_date`, `end_date`, `forever`, `launch`, `is_default`, `updated`, `created`, `created_by`, `last_login_ip`, `last_login_time`, `login_time`, `last_login_agent`, `use_cnt`, `app_last_login_ip`, `app_login_time`, `app_last_login_time`, `app_use_cnt`) VALUES
	('%s', 1, 0, NULL, '富網通', 'M', '管理員', NULL, NULL, NULL, 'admin', NULL, NULL, NULL, '8ceef0f75fb6babef17ae461e1260ca5ea52bf07', NULL, NULL, NULL, NULL, 'claire.huang@chupei.com.tw', NULL, '0928051327', NULL, 1, '2015-07-25 00:00:00', NULL, 1, 1, 0, '2016-05-14 10:30:21', '2015-06-04 13:57:20', '', '192.168.1.67', '2016-03-24 10:44:41', NULL, '[OS] Unknown Windows OS\n[Agent] Chrome 49.0.2623.87', 1, NULL, NULL, NULL, NULL);
...
INSERT INTO `sys_config` (`sn`, `id`, `value`, `param1`, `param2`, `desc`, `launch`, `updated`, `created`) VALUES
	(NULL, 'comm_id', '%s', NULL, NULL, NULL, 1, NULL, NULL);
