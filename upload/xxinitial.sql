...
-- 正在導出表  edoma.sys_module 的資料：~51 rows (大約)
...
(94, 51, 'landing', 1, 0, 2, '網站鎖定畫面背景', 'icon-coffee', 5, 1);
...
-- 正在導出表  edoma.sys_user_group_b_auth 的資料：~173 rows (大約)
...
INSERT INTO `web_setting` (`sn`, `title`, `key`, `value`, `memo`, `type`, `sort`, `launch`, `update_date`) VALUES
	...
	(3, '社區名稱', 'comm_name', '請輸入社區名稱', '', 'text', 30, 1, '2016-07-18 00:32:04'),
	(12, '社區簡介', 'comm_desc', '請輸入社區簡介', '', 'textarea', 36, 1, '2016-07-18 00:32:04'),
